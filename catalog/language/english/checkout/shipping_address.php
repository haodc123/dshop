<?php
// Heading
$_['heading_title_edit']    = 'Shipping address';
$_['heading_title_new']    = 'Shipping address';
...
$_['error_empty']                = 'Error: This field is required.';
$_['error_login']                  = '<p>We are sorry. There is no user account matching the E-mail and Password provided.</p><p>If you cannot remember your password use the link Have you forgotten your password?.</p><p>If you want to set up an account with a new user, use the Create account button.</p>';
$_['error_forgotten']                 =' The field <strong>E-mail</strong> is required. Please enter your e-mail address and press <strong>Retrieve password</strong>';
$_['error_warning']                  = 'There was a problem while trying to process your order! If the problem persists please try selecting a different shipping method or you can contact the store owner by <a href="%s">clicking here</a>.';
...
$_['error_shipping']                  = 'Warning: Payment method required!';
$_['error_no_shipping']               = 'Warning: No Payment options are available. Please <a href="%s">contact us</a> for assistance!';
?>