...
class ControllerCheckoutRegister extends Controller {
    ...
    public function index() {
       ...
       $this->data['text_content_note'] = $this->language->get('text_content_note');
       ...
       $this->data['error_empty'] = $this->language->get('error_empty');
        ...
        if ($this->config->get('config_account_id')) {
            ...
            if ($information_info) {
                ...
                $this->data['href']= $this->url->link('information/information/info', 'information_id=' . $this->config->get('config_account_id'), 'SSL');
    ...
    public function validate() {
        ...
        if (!$json) {
            ...
            if (utf8_strlen($this->request->post['email']) < 1) {
                $json['error']['email'] = $this->language->get('error_empty');
            } elseif (utf8_strlen($this->request->post['email']) > 96) {
           ...
           if (utf8_strlen($this->request->post['telephone']) < 1) {
            ...
            if (!isset($this->request->post['zone_id']) || $this->request->post['zone_id'] == '') {
             ...
             if (utf8_strlen($this->request->post['password']) < 1) {
                $json['error']['password'] = $this->language->get('error_empty');
             }elseif (utf8_strlen($this->request->post['password']) < 4)  {
                $json['error']['password'] = $this->language->get('error_password');
            }elseif (utf8_strlen($this->request->post['password']) > 20) {
                $json['error']['password'] = $this->language->get('error_password');
            }
              if (utf8_strlen($this->request->post['password']) < 1) {
                $json['error']['confirm'] = $this->language->get('error_empty');
