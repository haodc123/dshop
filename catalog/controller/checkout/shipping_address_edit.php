...
class ControllerCheckoutShippingAddressEdit extends Controller {
    ...
    public function index() {
        ...
        $this->data['heading_title_edit'] = $this->language->get('heading_title_edit');
        ...
        $address_info = $this->model_checkout_address->getAddress($this->request->get['shipping_address_id']);
        ...
        } elseif (isset($this->request->get['shipping_address_id'])) {
            $this->data['default'] = $this->customer->getAddressId() == $this->request->get['shipping_address_id'];
        } else {
            $this->data['default'] = false;
        }
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/shipping_address_edit.tpl')) {
            $this->template = $this->config->get('config_template') . '/template/checkout/shipping_address_edit.tpl';
        } else {
            $this->template = 'default/template/checkout/shipping_address_edit.tpl';
        }
    ...
    public function update() {
        ...
        if (!$json) {
                ...
                $this->model_checkout_address->editAddress($this->request->get['shipping_address_id'], $this->request->post);
                $this->session->data['shipping_address_id'] = $this->request->get['shipping_address_id'];
