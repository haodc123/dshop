...
<form action="<?php echo $action; ?>" method="post">
  ...
  <input type="hidden" name="item_number_<?php echo $i; ?>" value="<?php echo $product['mc']; ?>" />
  <input type="hidden" name="item_color_<?php echo $i; ?>" value="<?php echo $product['color']; ?>" />
  <input type="hidden" name="item_size_<?php echo $i; ?>" value="<?php echo $product['size']; ?>" />
  ...
  <div class="buttons">
    <div>
      <input type="submit" value="<?php echo $button_confirm; ?>" class="button_medium" />
    </div>
  </div>
</form>
