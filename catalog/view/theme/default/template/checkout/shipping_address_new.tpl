...
<body>
    <div id="container">
        ...
        <div id="content">
            <div class="content">
                <h2><?php echo $text_address_new; ?></h2>
                <div class="content">
                    <table class="form">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><select type="text" name="zone_id">
                                </select>
                            </td>
                        </tr>
   ...
   <script type="text/javascript">
    ...
    if($(this).val() == '') {
        $('#content input[name=\'firstname\']').after('<span id="firstname" class="error" style="display:none;"><i class="fa fa-exclamation-triangle"></i><?php echo $error_empty;?></span>');
 ...
 $('input[name=\'address_1\']').focus(function() {
  ...
  $('select[name=\'country_id\']').focus(function() {
    ...
    if($(this).val() == '') {
        $('#content select[name=\'country_id\']').after('<span id="country_id" class="error" style="display:none;"><i class="fa fa-exclamation-triangle"></i><?php echo $error_empty;?></span>');
...
$('select[name=\'zone_id\']').focus(function() {
    ...
    if($(this).val() == '') {
        $('#content select[name=\'zone_id\']').after('<span id="zone_id" class="error" style="display:none;"><i class="fa fa-exclamation-triangle"></i><?php echo $error_empty;?></span>');
     $('#zone_id').fadeIn(300);
}
});
 $('input[name=\'telephone\']').focus(function() {
    ...
    <script type="text/javascript"><!--
     $('select[name=\'country_id\']').bind('change', function() {
        $.ajax({
                url: 'index.php?route=checkout/shipping_address_new/country&country_id=' + this.value,
                dataType: 'json',
                beforeSend: function() {
...
//--></script> 
    ...
    $('#button_update').live('click', function() {
        ...
        $.ajax({
                    url: 'index.php?route=checkout/shipping_address_new/update',
                    type: 'post',
                            ...
                            if (json['error']){
                                    ...
                                    if (json['error']['country']) {
                                            $('#content select[name=\'country_id\']').after('<span id="country_id" class="error"><i class="fa fa-exclamation-triangle"></i> ' + json['error']['country'] + '</span>');
                                              if(top==0){ top= $('#content select[name=\'country_id\']').offset().top}
