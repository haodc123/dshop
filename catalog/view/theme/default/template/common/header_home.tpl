...
<html xmlns="http://www.w3.org/1999/xhtml" dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>">
    <head>
        ...
        <link rel="stylesheet" href="catalog/view/theme/default/App_Themes/Deal14/font-awesome/css/font-awesome.min.css">
            ...
            <?php } ?>
            <script language="javascript" type="text/javascript" src="catalog/view/javascript/js/jquery-1.7.2.min.js"></script>
        ...
        <div class="header_outer">
            <div class="header_inner">
                ...
                <div class="menu_main">
                    ...
                    <ul class="menu">
                        <li><a title="Home" href="http://mitadress.com/" class="active">Home</a></li>
                        <?php foreach ($categories as $category) { ?>
                        <li><a title="<?php echo $category['name']; ?>" href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a></li>
                        <?php } ?>
                       <li><a title="Blogs" href="<?php echo $blogs; ?>">Blogs</a></li>
                    </ul>
