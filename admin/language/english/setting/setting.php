...
$_['entry_receipt_prefix']         = 'Receipt Prefix:<br /><span class="help">Set the receipt prefix (e.g. REC-2011-00). Receipt ID\'s will start at 1 for each unique prefix</span>';
$_['entry_delivery_prefix']         = 'Delivery Prefix:<br /><span class="help">Set the Delivery prefix (e.g. DEL-2011-00). Delivery ID\'s will start at 1 for each unique prefix</span>';
