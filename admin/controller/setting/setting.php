...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['entry_invoice_prefix'] = $this->language->get('entry_invoice_prefix');
                $this->data['entry_receipt_prefix'] = $this->language->get('entry_receipt_prefix');
                $this->data['entry_delivery_prefix'] = $this->language->get('entry_delivery_prefix');
		...
		if (isset($this->request->post['config_invoice_prefix'])) {
			...
			$this->data['config_invoice_prefix'] = 'INV-' . date('Y') . '-00';
                ...
                if (isset($this->request->post['config_receipt_prefix'])) {
			$this->data['config_receipt_prefix'] = $this->request->post['config_receipt_prefix'];
		} elseif ($this->config->get('config_receipt_prefix')) {
			$this->data['config_receipt_prefix'] = $this->config->get('config_receipt_prefix');			
		} else {
			$this->data['config_receipt_prefix'] = 'REC-' . date('Y') . '-00';
		}
                if (isset($this->request->post['config_delivery_prefix'])) {
			$this->data['config_delivery_prefix'] = $this->request->post['config_delivery_prefix'];
		} elseif ($this->config->get('config_delivery_prefix')) {
			$this->data['config_delivery_prefix'] = $this->config->get('config_delivery_prefix');			
		} else {
			$this->data['config_delivery_prefix'] = 'DEL-' . date('Y') . '-00';
		}
