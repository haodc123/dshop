...
class ControllerPurchasePurchase extends Controller {
    ...
    public function index() {
        $this->language->load('purchase/purchase');
    ...
    public function insert() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            if (isset($this->request->get['filter_receipt_delivery'])) {
                $url .= '&filter_receipt_delivery=' . $this->request->get['filter_receipt_delivery'];
            }
            ...
            $this->redirect($this->url->link('purchase/purchase', 'token=' . $this->session->data['token'] . $url, 'SSL'));
        }
    ...
    public function delete() {
        ...
        if (isset($this->request->post['selected']) && ($this->validateDelete())) {
            ...
            $this->model_purchase_purchase->deletePurchase($this->request->get['purchase_id']);
            $this->session->data['success'] = $this->language->get('text_success');
    ...
    protected function getList() {
        ...
        if (isset($this->request->get['filter_receipt_delivery'])) {
            $filter_receipt_delivery = $this->request->get['filter_receipt_delivery'];
        } else {
            $filter_receipt_delivery ='';
        }
        if (isset($this->request->get['sort'])) {
        ...
        $this->data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('purchase/purchase', 'token=' . $this->session->data['token'] . $url, 'SSL'),
            'separator' => ' :: '
        );

        $this->data['invoice'] = $this->url->link('purchase/purchase/invoice', 'token=' . $this->session->data['token'] . $url, 'SSL');
        $this->data['insert'] = $this->url->link('purchase/purchase/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
        $this->data['delete'] = $this->url->link('purchase/purchase/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
        ...
        $data = array(
            'filter_receipt_delivery' => $filter_receipt_delivery,
        ...
        $purchase_total = $this->model_purchase_purchase->getTotalPurchases($data);
        $results = $this->model_purchase_purchase->getPurchases($data);
        $i = 1;
        foreach ($results as $result) {
            ...
            $action[] = array(
                ...
                'href' => $this->url->link('purchase/purchase/invoice', 'token=' . $this->session->data['token'] . '&purchase_id=' . $result['purchase_id'] . $url, 'SSL')
            );
            $action[] = array(
                'index' => 1,
                'text' => $this->language->get('text_edit'),
                'href' => $this->url->link('purchase/purchase/update', 'token=' . $this->session->data['token'] . '&purchase_id=' . $result['purchase_id'] . $url, 'SSL')
            );
            $action[] = array(
                'index' => 2,
                'text' => $this->language->get('text_delete'),
                'href' => $this->url->link('purchase/purchase/delete', 'token=' . $this->session->data['token'] . '&purchase_id=' . $result['purchase_id'] . $url, 'SSL')
            );
            $this->data['purchases'][] = array(
                'index' => $i++,
        ...
        $this->data['text_all_type'] = $this->language->get('text_all_type');
        ...
        $this->data['sort_quantity'] = $this->url->link('purchase/purchase', 'token=' . $this->session->data['token'] . '&sort=quantity' . $url, 'SSL');
        $this->data['sort_purchase_id'] = $this->url->link('purchase/purchase', 'token=' . $this->session->data['token'] . '&sort=purchase_id' . $url, 'SSL');
        $this->data['sort_reference_no'] = $this->url->link('purchase/purchase', 'token=' . $this->session->data['token'] . '&sort=reference_no' . $url, 'SSL');
        $this->data['sort_total'] = $this->url->link('purchase/purchase', 'token=' . $this->session->data['token'] . '&sort=total' . $url, 'SSL');
        $this->data['sort_date_added'] = $this->url->link('purchase/purchase', 'token=' . $this->session->data['token'] . '&sort=date_added' . $url, 'SSL');
        $this->data['sort_date_modified'] = $this->url->link('purchase/purchase', 'token=' . $this->session->data['token'] . '&sort=date_modified' . $url, 'SSL');
        ...
        $pagination->url = $this->url->link('purchase/purchase', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');

        $this->data['pagination'] = $pagination->render();
        $this->data['filter_receipt_delivery'] = $filter_receipt_delivery;
        ...
        $this->template = 'purchase/purchase_list.tpl';
        $this->children = array(
            'common/header',
            'common/footer'
        );
    ...
    public function getForm() {
        ...
        if (!isset($this->request->get['purchase_id'])) {
            $this->data['action'] = $this->url->link('purchase/purchase/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
        } else {
            $this->data['action'] = $this->url->link('purchase/purchase/update', 'token=' . $this->session->data['token'] . '&purchase_id=' . $this->request->get['purchase_id'] . $url, 'SSL');
        }

        $this->data['cancel'] = $this->url->link('purchase/purchase', 'token=' . $this->session->data['token'] . $url, 'SSL');
        ...
        if (isset($this->request->post['warehouse_id'])) {
         ...
         if (isset($this->request->post['receipt_delivery'])) {
            $this->data['receipt_delivery'] = $this->request->post['receipt_delivery'];
        } elseif (!empty($purchase_info)) {
            $this->data['receipt_delivery'] = $purchase_info['receipt_delivery'];
        } else {
            $this->data['receipt_delivery'] = '';
        }
        ...
        if (isset($this->request->post['reference_no'])) {
            ...
            $this->data['reference_no'] = $this->config->get('config_purchase_prefix') . $this->model_purchase_purchase->getTotalDate($this->data['date_added']);
        }
        ...
        $purchase_products = $this->model_purchase_purchase->getPurchaseProducts($this->data['purchase_id']);
        ...
        $this->template = 'purchase/purchase_form.tpl';
        $this->children = array(
            'common/header',
            'common/footer'
        );
    ...
    public function addProduct() {
        ...
        if ($this->user->isLogged() && $this->user->hasPermission('modify', 'purchase/purchase')) {
            // Product
            $this->load->model('purchase/purchase');
            if (isset($this->request->post['product_id'])) {
                $product_info = $this->model_purchase_purchase->getProduct($this->request->post['product_id']);
                if ($product_info) {
                    if (isset($this->request->post['quantity'])) {
            ...
            if (isset($this->request->post['purchase_product'])) {
                foreach ($this->request->post['purchase_product'] as $purchase_product) {
                    $product_info = $this->model_purchase_purchase->getProduct($purchase_product['product_id']);
                    if ($product_info) {
    ...
    public function barcode() {
        ...
        if ($this->user->isLogged() && $this->user->hasPermission('modify', 'purchase/purchase')) {
            ...
            if (isset($this->request->get['barcode'])) {
                $product_info = $this->model_purchase_purchase->getProductBarcode($this->request->get['barcode']);
    ...
    public function info() {
        ...
        if ($purchase_info) {
            ...
            $this->data['invoice'] = $this->url->link('purchase/purchase/invoice', 'token=' . $this->session->data['token'] . '&purchase_id=' . (int) $this->request->get['purchase_id'], 'SSL');
            $this->data['cancel'] = $this->url->link('purchase/purchase', 'token=' . $this->session->data['token'] . $url, 'SSL');
            $this->data['purchase_id'] = $this->request->get['purchase_id'];
            ...
            $purchases = $this->model_purchase_purchase->getPurchaseProducts($this->request->get['purchase_id']);
            ...
            $this->template = 'purchase/purchase_info.tpl';
            $this->children = array(
                'common/header',
                'common/footer'
            );
    ...
    public function createInvoiceNo() {
        ...
        if (!$this->user->hasPermission('modify', 'purchase/purchase')) {
            ...
            $invoice_no = $this->model_purchase_purchase->createInvoiceNo($this->request->get['purchase_id']);
    ...
    public function addCredit() {
        ...
        if (!$this->user->hasPermission('modify', 'purchase/purchase')) {
            ...
            if ($purchase_info && $purchase_info['supplier_id']) {
                ...
                $credit_total = $this->model_sale_supplier->getTotalTransactionsByPurchaseId($this->request->get['purchase_id']);
    ...
    public function addReward() {
        ...
        if (!$this->user->hasPermission('modify', 'purchase/purchase')) {
            ...
            if ($purchase_info && $purchase_info['supplier_id']) {
                ...
                $reward_total = $this->model_sale_supplier->getTotalCustomerRewardsByPurchaseId($this->request->get['purchase_id']);
    ...
    public function addCommission() {
        ...
        if (!$this->user->hasPermission('modify', 'purchase/purchase')) {
            ...
            if ($purchase_info && $purchase_info['affiliate_id']) {
                ...
                $affiliate_total = $this->model_sale_affiliate->getTotalTransactionsByPurchaseId($this->request->get['purchase_id']);
    ...
    public function history() {
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST') {
            ...
            if (!$this->data['error']) {
                $this->model_purchase_purchase->addPurchaseHistory($this->request->get['purchase_id'], $this->request->post);
        ...
        $results = $this->model_purchase_purchase->getPurchaseHistories($this->request->get['purchase_id'], ($page - 1) * 10, 10);
        ...
        $history_total = $this->model_purchase_purchase->getTotalPurchaseHistories($this->request->get['purchase_id']);
        ...
        $pagination->limit = 10;
        $pagination->text = $this->language->get('text_pagination');
        $pagination->url = $this->url->link('purchase/purchase/history', 'token=' . $this->session->data['token'] . '&purchase_id=' . $this->request->get['purchase_id'] . '&page={page}', 'SSL');

        $this->data['pagination'] = $pagination->render();

        $this->template = 'purchase/purchase_history.tpl';
    ...
    public function invoice() {
        ...
        foreach ($purchases as $purchase_id) {
            ...
            $purchase_data = array();
            $purchases = $this->model_purchase_purchase->getPurchaseProducts($purchase_id);
            foreach ($purchases as $purchase) {
                $purchase_data[] = array(
                    'name' => $purchase['name'],
                    'model' => $purchase['model'],
        ...
        $this->template = 'purchase/purchase_invoice.tpl';
        $this->response->setOutput($this->render());
    }
