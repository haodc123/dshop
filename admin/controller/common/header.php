...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_sale'] = $this->language->get('text_sale');
                ...
                $this->data['text_list_purchase'] = $this->language->get('text_list_purchase');
		...
		$this->data['text_zone'] = $this->language->get('text_zone');
                ...
                $this->data['text_receipt_note'] = $this->language->get('text_receipt_note');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['category'] = $this->url->link('catalog/category', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['price_level'] = $this->url->link('catalog/price_level', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['order_status'] = $this->url->link('localisation/order_status', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['purchase_status'] = $this->url->link('localisation/purchase_status', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['zone'] = $this->url->link('localisation/zone', 'token=' . $this->session->data['token'], 'SSL');
                        ...
                        $this->data['delivery_note'] = $this->url->link('purchase/warehouse', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['receipt_note'] = $this->url->link('warehouse/receipt_note', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['warehouse'] = $this->url->link('purchase/warehouse', 'token=' . $this->session->data['token'], 'SSL');
			
                       $this->data['seo_editor'] = $this->url->link('seo/seo_editor', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['tags'] = $this->url->link('seo/tag', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['purchase'] = $this->url->link('purchase/purchase', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['receipt'] = $this->url->link('purchase/receipt', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['delivery'] = $this->url->link('purchase/delivery', 'token=' . $this->session->data['token'], 'SSL');
