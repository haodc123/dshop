	...
	private $error = array();
  	...
  	protected function getForm() {
		...
		if (isset($this->request->post['keyword'])) {
			...
			$this->data['keyword'] = $supplier_info['keyword'];
		} else {
			$this->data['keyword'] = '';
		}
		...
		if (isset($this->request->post['image'])) {
			...
			$this->data['image'] = $supplier_info['image'];
		} else {
			$this->data['image'] = '';
		}
		...
		} elseif (!empty($supplier_info) && $supplier_info['image'] && file_exists(DIR_IMAGE . $supplier_info['image'])) {
			$this->data['thumb'] = $this->model_tool_image->resize($supplier_info['image'], 100, 100);
		} else {
