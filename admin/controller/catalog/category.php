...
class ControllerCatalogCategory extends Controller { 
	...
	protected function getList() {
		...
		$this->data['export'] = $this->url->link('catalog/category/downloadCategories', 'token=' . $this->session->data['token'] . $url, 'SSL');
	...
	public function autocomplete() {
		...
		if ($this->validate()) {
			...
			$this->model_tool_export->downloadCategories();
			$this->redirect( $this->url->link( 'catalog/category', 'token='.$this->request->get['token'], 'SSL' ) );
