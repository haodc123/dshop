...
class ControllerCatalogProduct extends Controller {
    ...
    public function insert() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm() && $this->validateInsert()) {
            ...
            if (isset($this->request->get['filter_mcs'])) {
                $url .= '&filter_mcs=' . urlencode(html_entity_decode($this->request->get['filter_mcs'], ENT_QUOTES, 'UTF-8'));
            }
            if (isset($this->request->get['filter_mc'])) {
                $url .= '&filter_mc=' . urlencode(html_entity_decode($this->request->get['filter_mc'], ENT_QUOTES, 'UTF-8'));
            }
            if (isset($this->request->get['filter_color'])) {
                $url .= '&filter_color=' . urlencode(html_entity_decode($this->request->get['filter_color'], ENT_QUOTES, 'UTF-8'));
            }
            ...
            if (isset($this->request->get['filter_display'])) {
                $url .= '&filter_display=' . $this->request->get['filter_display'];
            }
...
//            }
    ...
    protected function getList() {
        ...
        if (isset($this->request->get['filter_mcs'])) {
            $filter_mcs = $this->request->get['filter_mcs'];
        } else {
            $filter_mcs = null;
        }
        if (isset($this->request->get['filter_mc'])) {
            $filter_mc = $this->request->get['filter_mc'];
        } else {
            $filter_mc = null;
        }
        if (isset($this->request->get['filter_model'])) {
        ...
        if (isset($this->request->get['filter_display'])) {
            $filter_display = $this->request->get['filter_display'];
        } else {
            $filter_display = null;
        }
        ...
        $this->data['open'] = $this->url->link('catalog/product/open', 'token=' . $this->session->data['token'], 'SSL');
        $this->data['import'] = $this->url->link('catalog/product/import', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $this->data['barcode'] = $this->url->link('catalog/product/barcode', 'token=' . $this->session->data['token'] . $url, 'SSL');
        ...
        foreach ($results as $result) {
            ...
            $action[] = array(
                'index' => 1,
                'text' => $this->language->get('text_barcode'),
                'href' => $this->url->link('catalog/product/barcode', 'token=' . $this->session->data['token'] . '&mcs=' . $result['mcs'] . $url, 'SSL')
            );
             $action[] = array(
                'index' => 2,
                'text' => $this->language->get('text_delete'),
                'href' => $this->url->link('catalog/product/delete_row', 'token=' . $this->session->data['token'] . '&product_id=' . $result['product_id'] . $url, 'SSL')
            );
            $status[] = array(
                'status'=>$result['status'],
                'text' => $result['status'] ?  $this->language->get('text_enabled') :  $this->language->get('text_disabled') , // $this->language->get('text_barcode'),
                'href' => $this->url->link('catalog/product/status', 'token=' . $this->session->data['token'] . '&status=' . $result['status'] . '&product_id=' . $result['product_id'] . $url, 'SSL'),
            );
            $display[] = array(
                'display'=>$result['display'],
                'text' => $result['display'] ?  $this->language->get('text_enabled') :  $this->language->get('text_disabled') ,
                'href' => $this->url->link('catalog/product/display', 'token=' . $this->session->data['token'] . '&display=' . $result['display'] . '&product_id=' . $result['product_id'] . $url, 'SSL'),
            );
             if ($result['image'] && file_exists(DIR_IMAGE . $result['image'])) {
                $image = $this->model_tool_image->resize($result['image'], 30, 38);
            } else {
                $image = $this->model_tool_image->resize('no_image.jpg', 30, 38);
            }
            ...
            $this->data['products'][] = array(
                ...
                'color_code' => isset($color['color']) ? $color['color'] : "",
                'image' => $image,
                'quantity' => $result['quantity'],
                'status' => $status,//$result['status'],
                'display' => $display,$result['display'],
              //  'href' => $this->url->link('catalog/product/display', 'token=' . $this->session->data['token'] . '&display=' . $result['display']. '&product_id=' .$result['product_id'] . $url, 'SSL'),
               // 'href' => $this->url->link('catalog/product/status', 'token=' . $this->session->data['token'] . '&status=' . $result['display']. '&product_id=' .$result['product_id'] . $url, 'SSL'),
        ...
        $this->data['column_display'] = $this->language->get('column_display');
        $this->data['column_action'] = $this->language->get('column_action');

        $this->data['button_copy'] = $this->language->get('button_copy');
        $this->data['button_insert_new'] = $this->language->get('button_insert_new');
        $this->data['button_insert'] = $this->language->get('button_insert');
        $this->data['button_export'] = $this->language->get('button_export');
        $this->data['button_import'] = $this->language->get('button_import');
        $this->data['button_barcode'] = $this->language->get('button_barcode');
...
//        }
        ...
        $this->data['sort_mcs'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'] . '&sort=p.mcs' . $url, 'SSL');
        $this->data['sort_mc'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'] . '&sort=p.mc' . $url, 'SSL');
        $this->data['sort_color'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'] . '&sort=p.color' . $url, 'SSL');
        ...
        $this->data['sort_display'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'] . '&sort=p.display' . $url, 'SSL');
...
//        }
        ...
        $this->data['filter_mc'] = $filter_mc;
        $this->data['filter_mcs'] = $filter_mcs;
        $this->data['filter_color'] = $filter_color;
        $this->data['filter_price'] = $filter_price;
        $this->data['filter_quantity'] = $filter_quantity;
        $this->data['filter_status'] = $filter_status;
        $this->data['filter_display'] = $filter_display;
    ...
    public function barcode() {
        ...
        $this->data['mcs'] = '';
        if (isset($this->request->get['mcs'])) {
            $this->data['mcs'] = $this->request->get['mcs'];
        }
        $this->template = 'catalog/product_barcode.tpl';
        $this->response->setOutput($this->render());
    }
    ...
    protected function getForm() {
        ...
        $this->data['entry_guide'] = $this->language->get('entry_guide');
        ...
        $this->data['entry_mc'] = $this->language->get('entry_mc');
        $this->data['entry_mcs'] = $this->language->get('entry_mcs');
        $this->data['entry_color'] = $this->language->get('entry_color');
        ...
        if (isset($this->error['introduction'])) {
            $this->data['error_introduction'] = $this->error['error_introduction'];
        } else {
            $this->data['error_introduction'] = array();
        }
        ...
        if (isset($this->error['guide'])) {
            $this->data['error_guide'] = $this->error['error_guide'];
        } else {
            $this->data['error_guide'] = array();
        }
...
//        }
        ...
        if (isset($this->request->post['display'])) {
            ...
            $this->data['display'] = $product_info['display'];
        } else {
            $this->data['display'] = 1;
        }
...
//        $product_total = $this->model_catalog_product->getEditTotalProductsByModelColor($this->request->post['color'], $this->request->post['model']);
//        if ($product_total) {
//            $this->error['warning'] = sprintf($this->language->get('error_color_model'), $product_total);
//        }
...
//        $product_total = $this->model_catalog_product->getTotalProductsByModelColor($this->request->post['color'], $this->request->post['model']);
//        if ($product_total) {
//            $this->error['warning'] = sprintf($this->language->get('error_color_model'), $product_total);
//        }
    ...
    public function autocomplete() {
        ...
        if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_mcs']) || isset($this->request->get['filter_mc']) || isset($this->request->get['filter_model']) || isset($this->request->get['filter_category_id'])) {
            $this->load->model('catalog/product');
            $this->load->model('catalog/option');
    ...
    public function export() {
        if ($this->validate()) {
            ...
            $this->model_tool_export->downloadProduct();
   ...
   public function display() {
        ...
        $this->model_catalog_product->editDisplay($this->request->get['product_id'], $this->request->get['display']);
    ...
    public function status() {
        ...
        $this->model_catalog_product->editStatus($this->request->get['product_id'], $this->request->get['status']);
    ...
    public function open() {
		...
		if (isset($this->request->server['HTTPS']) && (($this->request->server['HTTPS'] == 'on') || ($this->request->server['HTTPS'] == '1'))) {
            ...
            if ($this->config->get('config_logo') && file_exists(DIR_IMAGE . $this->config->get('config_logo'))) {
                $this->data['logo'] =$this->data['base'] . 'view/image/' . $this->config->get('config_logo');
            } else {
            $this->data['logo'] = '';
             }
		$this->language->load('catalog/product');
...
//        }
        ...
        if (!isset($this->request->get['product_id'])) {
            $this->data['action'] = $this->url->link('catalog/product/insert_new', 'token=' . $this->session->data['token'] . $url, 'SSL');
        } else {
            $this->data['action'] = $this->url->link('catalog/product/update', 'token=' . $this->session->data['token'] . '&product_id=' . $this->request->get['product_id'] . $url, 'SSL');
        }
        ...
        $this->template = 'catalog/product_open.tpl';
        $this->children = array(
            'common/header',
            'common/footer'
        );
    ...
    public function insert_new() {
        ...
        $this->load->model('catalog/product');
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm() && $this->validateInsert()) {
            $this->model_catalog_product->addProductOpen($this->request->post);
            $this->redirect($this->url->link('catalog/product/open', 'token=' . $this->session->data['token'] . $url, 'SSL'));
           }
          $this->redirect($this->url->link('catalog/product/open', 'token=' . $this->session->data['token'] . $url, 'SSL'));
    }
