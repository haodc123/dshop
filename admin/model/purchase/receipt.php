...
class ModelPurchaseReceipt extends Model {
    ...
    public function editReceipt($purchase_id, $data) {
    ...
    public function comfirmReceipt($purchase_id) {
    ...
    public function deleteReceipt($purchase_id) {
    ...
    public function getReceipts($data = array()) {
        ...
        $sql = "SELECT DISTINCT * FROM " . DB_PREFIX . "purchase WHERE language_id='" . (int) $this->config->get('config_language_id') . "' AND status=0 AND receipt_delivery='receipt'";
...
//        if (!empty($data['filter_purchase_status_id'])) {
//            $sql .= " AND purchase_status_id = '" . (int) $data['filter_purchase_status_id'] . "'";
//        }
...
//        }
    ...
    public function getReceiptProducts($purchase_id) {
    ...
    public function getReceiptOptions($purchase_id, $purchase_product_id) {
