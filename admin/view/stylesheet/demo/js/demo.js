...
$(document).ready(function(){
	...
	$("#editme1").editInPlace({
		callback: function(unused,html, enteredText) {
                    $("#updateDiv1").html("The original html was: " + enteredText);
			$("#updateDiv2").html("The updated text is: " + html);
                    return html; },
		url: 'index.php?route=purchase/purchase/abc&token=<?php echo $token; ?>',
		 params: "name=david"
	});
	...
	$("#editme4").editInPlace({
		callback: function(unused,enteredText){
			$("#updateDiv1").val(enteredText);
                          
			//$("#updateDiv2").html("The updated text is: " + enteredText);
			return(enteredText);
		}
	});
