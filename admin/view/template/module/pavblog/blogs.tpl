					...
					<form id="filter" method="post" action="<?php echo $action;?>">
						 <div class="filter-wrap clearfix">
							<div class="filter-title "><label><?php echo $this->language->get('text_filter_title');?></label>
								<input type="text" name="filter[title]" value="<?php echo $filter['title'];?>" size="50">
							</div>
						...
						<table class="list">
							...
							<tbody>
								...
								<tr>
									...
									<td class="center"  ><input type="text" name="position[<?php echo $blog['blog_id'];?>]" value="<?php echo $blog['position'];?>" size="3"></td>
