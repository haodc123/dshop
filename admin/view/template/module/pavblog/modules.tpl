							...
							<div class="clearfix clear"></div>
								...
								<table class="form">
									...
									<tr>
										...
										<td>
											<input type="text" name="pavblog[general_lwidth]" value="<?php echo $general_setting['general_lwidth'];?>" size="3"/> 
											x 
											<input type="text" size="3" name="pavblog[general_lheight]" value="<?php echo $general_setting['general_lheight'];?>" />
										</td>
									</tr>
									<tr>
										<td><?php echo $this->language->get('entry_small_image_demension');?></td>
										<td>
											<input type="text" name="pavblog[general_swidth]" value="<?php echo $general_setting['general_swidth'];?>" size="3"/>
											x 
											<input type="text" size="3" name="pavblog[general_sheight]" value="<?php echo $general_setting['general_sheight'];?>" />
										</td>
									</tr>
									<tr>
										<td><?php echo $this->language->get('entry_xsmall_image_demension');?></td>
										<td>
											<input type="text" name="pavblog[general_xwidth]" value="<?php echo $general_setting['general_xwidth'];?>" size="3"/> 
											x 
											<input type="text" size="3" name="pavblog[general_xheight]" value="<?php echo $general_setting['general_xheight'];?>" />
										</td>
									</tr>
									
									<tr>
										<td><?php echo $this->language->get('entry_rss_limit');?></td>
										<td><input type="text" size="3" name="pavblog[rss_limit_item]" value="<?php echo $general_setting['rss_limit_item'];?>" /></td>
									</tr>
									<tr>
										<td colspan="2">
									...
									<tr>
										...
										<td><input type="text" size="30" name="pavblog[keyword_listing_blogs_page]" value="<?php echo $general_setting['keyword_listing_blogs_page'];?>" /></td>
									</tr>	
								</table>
								<div class="clearfix clear"></div>
						</div>
								 ...
								 <div class="clearfix clear"></div>
									<table class="form">
										<tr>
											...
											<td>
												<input type="text" name="pavblog[children_columns]" value="<?php echo $general_setting['children_columns'];?>" size="10"/>
											</td>
										</tr>
										<tr>
											<td><?php echo $this->language->get('entry_category_image_demension');?></td>
											<td>
												<input type="text" name="pavblog[general_cwidth]" value="<?php echo $general_setting['general_cwidth'];?>" size="3"/> 
												x 
												<input type="text" size="3" name="pavblog[general_cheight]" value="<?php echo $general_setting['general_cheight'];?>" />
											</td>
										</tr> 
										<tr>
											<td><?php echo $this->language->get('entry_limit_leading_blogs');?></td>
											<td>
												<input type="text" name="pavblog[cat_limit_leading_blog]" value="<?php echo $general_setting['cat_limit_leading_blog'];?>" size="10"/>
											</td>
										</tr>
										<tr>
											<td><?php echo $this->language->get('entry_limit_secondary_blogs');?></td>
											<td>
												<input type="text" name="pavblog[cat_limit_secondary_blog]" value="<?php echo $general_setting['cat_limit_secondary_blog'];?>" size="10"/>
											</td>
										</tr>
										...
										<tr>
											...
											<td>
												<input type="text" name="pavblog[cat_columns_leading_blog]" value="<?php echo $general_setting['cat_columns_leading_blogs'];?>" size="10"/>
											</td>
										</tr>
										<tr>
											<td><?php echo $this->language->get('entry_columns_secondary_blogs');?></td>
											<td>
												<input type="text" name="pavblog[cat_columns_secondary_blogs]" value="<?php echo $general_setting['cat_columns_secondary_blogs'];?>" size="10"/>
											</td>
										</tr>
										<tr>
							...
							<div id="tab-blog-setting" >
								...
								<table class="form">
									...
									<tr>
										...
										<td><input type="text" name="pavblog[diquis_account]" value="<?php echo $general_setting['diquis_account'];?>" size="30"/>
										<br>
									...
									<tr>
										...
										<td>
											<input type="text" name="pavblog[facebook_appid]" value="<?php echo $general_setting['facebook_appid'];?>" size="30"/>
									...
									<tr>
										...
										<td><input type="text" name="pavblog[comment_limit]" value="<?php echo $general_setting['comment_limit'];?>" size="30"/></td>
									</tr>
									<tr>
										<td><?php echo $this->language->get('entry_facebook_width');?></td>
										<td><input type="text" name="pavblog[facebook_width]" value="<?php echo $general_setting['facebook_width'];?>" size="30"/></td>
									</tr>
						...
						if(!empty($layout_modules)){
							foreach($layout_modules as $key=>$item_module){
								...
								if(!is_array($item_module)){
									...
									<div id="tab-module-<?php echo $key;?>">
										<div class="tab-inner">
											<input type="text" type="hidden" name="pavblog[modules][]" value="<?php echo $key;?>"/>
											<?php
