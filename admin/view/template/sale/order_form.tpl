              ...
              <tr id="product-row<?php echo $product_row; ?>">
                ...
                <td class="left"><?php echo $order_product['name']; ?><br />
                   <div style="font-size: 11px; font-style: italic; ">
                    <span><?php echo $text_color;?></span><span style="background-color:#fafafa;"><?php echo $order_product['color']; ?></span><br/>
                    <span><?php echo $text_size;?></span><span><?php echo $order_product['size']; ?></span>
                  </div>
                ...
                <td class="left"><?php echo $order_product['mcs']; ?>
                  <input type="hidden" name="order_product[<?php echo $product_row; ?>][mcs]" value="<?php echo $order_product['mcs']; ?>" />
                  <input type="hidden" name="order_product[<?php echo $product_row; ?>][mc]" value="<?php echo $order_product['mc']; ?>" />
            ...
            <tbody id="total">
              ...
              <tr>
                ...
                <td class="left"><?php echo $order_product['model']; ?></td>
                 <td class="left"><?php echo $order_product['mcs']; ?></td>
		...
		success: function(json) {
			...
			if (json['order_product'] != '') {
				...
				for (i = 0; i < json['order_product'].length; i++) {
					...
					html += '  <td class="left">' + product['mcs'] + '<input type="hidden" name="order_product[' + product_row + '][mcs]" value="' + product['mcs'] + '" /><input type="hidden" name="order_product[' + product_row + '][mc]" value="' + product['mc'] + '" /><input type="hidden" name="order_product[' + product_row + '][color]" value="' + product['color'] + '" /><input type="hidden" name="order_product[' + product_row + '][size]" value="' + product['size'] + '" /></td>';
				...
				if (json['order_product'] != '') {
					for (i = 0; i < json['order_product'].length; i++) {
						...
						html += '  <td class="left">' + product['model'] + '</td>';
                                                html += '  <td class="left">' + product['mcs'] + '</td>';
