...
<div id="header">
  <div class="div1">
    <div class="div2"><img src="http://mitadress.com/image/data/mitadress - slogan.png" title="<?php echo $heading_title; ?>" onclick="location = '<?php echo $home; ?>'" /></div>
    <?php if ($logged) { ?>
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      ...
      <li id="seo"><a class="top"><?php echo $text_seo; ?></a>
        <ul>
            <?php if ($this->user->hasPermission('access', 'seo/tag')){ ?>
          <li><a href="<?php echo $tags; ?>"><?php echo $text_tags; ?></a></li>
            <?php } ?>
          <?php if ($this->user->hasPermission('access', 'seo/seo_editor')){ ?>
          <li><a href="<?php echo $seo_editor; ?>"><?php echo $text_editor; ?></a></li>
            <?php } ?>
        </ul>
      </li>
        ...
        <li id="catalog"><a class="top"><?php echo $text_catalog; ?></a>
          <ul>
              ...
              <?php } ?>
              <?php if ($this->user->hasPermission('access', 'catalog/supplier')){ ?>
              ...
              <?php } ?>
              <?php if ($this->user->hasPermission('access', 'catalog/price_level')){ ?>
              <li><a href="<?php echo $price_level; ?>"><?php echo $text_price_level; ?></a></li>
              <?php } ?>
              <?php if ($this->user->hasPermission('access', 'catalog/color')){ ?>
              <li><a href="<?php echo $color; ?>"><?php echo $text_color; ?></a></li>
              <?php } ?>
              <?php if ($this->user->hasPermission('access', 'catalog/size')){ ?>
      ...
      <li id="sale"><a class="top"><?php echo $text_sale; ?></a>
       ...
       <li id="purchase"><a class="top"><?php echo $text_purchase; ?></a>
          <ul>
              <?php if ($this->user->hasPermission('access', 'purchase/purchase')){ ?>
              <li><a href="<?php echo $purchase; ?>"><?php echo $text_list_purchase; ?></a></li>
              <?php } ?>
              <?php if ($this->user->hasPermission('access', 'purchase/receipt')){ ?>
              <li><a href="<?php echo $receipt; ?>"><?php echo $text_receipt_note; ?></a></li>
              <?php } ?>
              <?php if ($this->user->hasPermission('access', 'purchase/delivery')){ ?>
              <li><a href="<?php echo $delivery; ?>"><?php echo $text_delivery_note; ?></a></li>
              <?php } ?>
              <?php if ($this->user->hasPermission('access', 'purchase/warehouse')){ ?>
              <li><a href="<?php echo $warehouse; ?>"><?php echo $text_warehouse; ?></a></li>
              <?php } ?>
              <?php if ($this->user->hasPermission('access', 'purchase/purchase_status')){ ?>
              <li><a href="<?php echo $purchase_status; ?>"><?php echo $text_purchase_status; ?></a></li>
              <?php } ?>
          </ul>
      </li>
      ...
      <li id="system"><a class="top"><?php echo $text_system; ?></a>
        <ul>
             <?php if ($this->user->hasPermission('access', 'system/setting')){ ?>
          ...
          <li><a class="parent"><?php echo $text_design; ?></a>
            <ul>
                 <?php if($this->user->hasPermission('access', 'system/layout')){ ?>
              <li><a href="<?php echo $layout; ?>"><?php echo $text_layout; ?></a></li>
              <?php } ?>
               <?php if ($this->user->hasPermission('access', 'system/banner')){ ?>
            ...
            <li id="reports"><a class="top"><?php echo $text_reports; ?></a>
              <ul>
                  ...
                  <li><a class="parent"><?php echo $text_sale; ?></a>
                      <ul>
                          <?php if ($this->user->hasPermission('access', 'report/report_sale_order')){ ?>
                          <li><a href="<?php echo $report_sale_order; ?>"><?php echo $text_report_sale_order; ?></a></li>
                          <?php } ?>
                          <?php if ($this->user->hasPermission('access', 'report/report_sale_tax')){ ?>
      ...
      <li id="help"><a class="top"><?php echo $text_help; ?></a>
        <ul>
          <li><a href="http://www.mitadress.com" target="_blank"><?php echo $text_opencart; ?></a></li>
          <li><a href="http://www.mitadress.com/index.php?route=documentation/introduction" target="_blank"><?php echo $text_documentation; ?></a></li>
          <li><a href="http://forum.opencart.com" target="_blank"><?php echo $text_support; ?></a></li>
        </ul>
      </li>
    </ul>
    <ul class="right" style="display: none;">
        <li id="warehouse"><a class="top"><?php echo $text_warehouse; ?></a>
           <ul>
               <li><a href="<?php $delivery_note; ?>"><?php echo $text_delivery_note; ?></a></li>
               <li><a href="<?php echo $receipt_note; ?>"><?php echo $text_receipt_note; ?></a></li>
