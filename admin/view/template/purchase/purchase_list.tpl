  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/purchase.png" alt="" /> <?php echo $heading_title; ?></h1>
         <?php if ($this->user->hasPermission('modify', 'purchase/purchase')){ ?>
            <div class="buttons">
                <?php if ($this->user->hasPermission('invoice', 'purchase/purchase')){ ?>
                <a onclick="$('#form').attr('action', '<?php echo $invoice; ?>'); $('#form').attr('target', '_blank'); $('#form').submit();" class="button"><?php echo $button_invoice; ?></a>
                <?php } ?>
                <?php if ($this->user->hasPermission('delete', 'purchase/purchase')){ ?>
      ...
      <form action="" method="post" enctype="multipart/form-data" id="form">
        ...
        <tr>
          ...
          <td><?php echo $entry_status; ?>
              <select name="filter_receipt_delivery">
                  <?php if($filter_receipt_delivery=='receipt') { ?>
                  <option value=""><?php echo $text_all_type;?></option> 
                  <option value="delivery"><?php echo $text_delivery; ?></option>
                  <option value="receipt" selected="selected"><?php echo $text_receipt; ?></option> 
                  <?php }elseif($filter_receipt_delivery=='delivery') { ?>
                  <option value=""><?php echo $text_all_type;?></option> 
                  <option value="delivery" selected="selected"><?php echo $text_delivery; ?></option>
                  <option value="receipt"><?php echo $text_receipt; ?></option> 
                  <?php }else { ?>
                  <option value="" selected="selected"><?php echo $text_all_type;?></option> 
                  <option value="delivery"><?php echo $text_delivery; ?></option>
                  <option value="receipt"><?php echo $text_receipt; ?></option> 
                  <?php } ?>
              </select></td>
            ...
            <tr>
              ...
              <td class="right">
                  ...
                  <?php if($action['index']==0){ ?>
                     <?php if ($this->user->hasPermission('view', 'purchase/purchase')){ ?>
                ...
                <?php if($action['index']==1){ ?>
                  <?php if ($this->user->hasPermission('edit', 'purchase/purchase')){ ?>
...
function filter() {
	...
	if (filter_date_modified) {
        ...
        var filter_receipt_delivery = $('select[name=\'filter_receipt_delivery\']').attr('value');
	if (filter_receipt_delivery) {
		url += '&filter_receipt_delivery=' + encodeURIComponent(filter_receipt_delivery);
	}
	location = url;
}
//--></script>  
