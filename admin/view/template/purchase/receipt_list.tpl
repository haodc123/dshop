  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/purchase.png" alt="" /> <?php echo $heading_title; ?></h1>
         <?php if ($this->user->hasPermission('modify', 'purchase/receipt')){ ?>
      <div class="buttons">
             <?php if ($this->user->hasPermission('invoice', 'purchase/receipt')){ ?>
                <a onclick="$('#form').attr('action', '<?php echo $invoice; ?>'); $('#form').attr('target', '_blank'); $('#form').submit();" class="button"><?php echo $button_invoice; ?></a>
           <?php } ?>
             <?php if ($this->user->hasPermission('insert', 'purchase/receipt')){ ?>
                <a href="<?php echo $insert; ?>" class="button"><?php echo $button_insert; ?></a>
           <?php } ?>
             <?php if ($this->user->hasPermission('delete', 'purchase/receipt')){ ?>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="right">
                  ...
                  <?php if ($this->user->hasPermission('edit', 'purchase/receipt')){ ?>
                  ...
                  <?php if ($this->user->hasPermission('comfirm', 'purchase/receipt')){ ?>
