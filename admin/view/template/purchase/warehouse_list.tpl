      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($warehouse['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php echo $warehouse['name']; ?></td>
              <td class="right"><?php echo $warehouse['sort_order']; ?></td>
              <td class="right"><?php foreach ($warehouse['action'] as $action) { ?>
