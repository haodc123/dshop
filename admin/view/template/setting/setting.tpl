      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-option">
          ...
          <table class="form">
            ...
            <tr>
              <td><?php echo $entry_receipt_prefix; ?></td>
              <td><input type="text" name="config_receipt_prefix" value="<?php echo $config_receipt_prefix; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_delivery_prefix; ?></td>
              <td><input type="text" name="config_delivery_prefix" value="<?php echo $config_delivery_prefix; ?>" /></td>
            </tr>
            <tr>
