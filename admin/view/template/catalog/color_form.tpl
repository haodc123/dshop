        ...
        <div id="tab-general">
          <table class="form">
            <tr>
             ...
             <tr>
              <td><?php echo $entry_color; ?><span class="required">*</span></td>
              <td><input type="text" name="color" value="<?php echo $color; ?>" size="20" />
                <?php if ($error_color) { ?>
             ...
             <tr>
              ...
              <td><input type="text" name="code" value="<?php echo $code; ?>" size="20" />
                <?php if ($error_code) { ?>
